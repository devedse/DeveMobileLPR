...
public sealed class RecognitionTuningConfigurationTests
{
    ...
    public void Defaults_AreTheDocumentedProductionProfile()
    {
        ...
        Assert.Equal(new NormalizedRegion(0f, 0.18f, 1f, 0.94f), configuration.Detector_RoadRegion);
        ...
        Assert.Equal(0.80f, configuration.ConfirmationCorrection_MinimumConfidence);
    }
