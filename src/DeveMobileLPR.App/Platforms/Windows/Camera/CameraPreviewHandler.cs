...
internal sealed class CameraPreviewHandler : ViewHandler<CameraPreview, WinUIGrid>
{
    ...
    private WindowsDriveVideoInput? _source;
    ...
    protected override WinUIGrid CreatePlatformView()
    {
        ...
        {
            Background = new Microsoft.UI.Xaml.Media.SolidColorBrush(global::Windows.UI.Color.FromArgb(255, 11, 13, 16))
        };
        ...
        _source = new WindowsDriveVideoInput(
            preview,
            streamPreview,
    ...
    private static async Task DisposeSourceAsync(WindowsDriveVideoInput source)
    {
        try
        {
